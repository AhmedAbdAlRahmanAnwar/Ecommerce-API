...
const validateUpdatedAddressData = [
    ...
    body("payload.city").optional().matches(/^[a-zA-Z]{3,}$/).withMessage("city should be a string"),
    body("payload.country").optional().matches(/^[a-zA-Z]{3,}$/).withMessage("country should be a string"),
